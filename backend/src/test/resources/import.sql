...
INSERT INTO users (address, cellphone, code, email, email_verified, image_url, name, personal_email, provider, provider_id, id_rol) VALUES ('av 4 # 4 - 10 Quinta orienta', '3222103336', '1151197', 'andrespedro@ufps.edu.co', 0, 'https://lh6.googleuserconten', 'Andres Pedro', NULL, 'google', '105035634800495666221', 1);

INSERT INTO project (start_date, abstracts) VALUE("2020-11-05","Como usuario requiero ingresar al aplicativo con los datos correo institucional/contraseña en la interfaz de autenticación de google; y al momento de querer salir del mismo, disponer de un botón para cerrar la sesión, para facilitar la entrada y salida de la página. ")
